...
export default function AlertsView({ transactions = [] }) {
  const fraudAlerts = transactions.filter(tx => tx.is_fraud === 1);
  return (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4 dark:mb-2 pl-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-mm-textDark dark:text-white text-lg dark:text-sm dark:font-mono">Fraudulent Activity</h4>
                  ...
                  <div className="text-right">
                    <div className="font-mono text-sm dark:text-[10px] font-bold text-mm-textDark dark:text-white">
                ...
                <div className="pl-14 dark:pl-12 text-sm dark:text-xs text-mm-textMuted dark:text-mm-dark-textMuted mb-4 dark:mb-3 leading-relaxed dark:font-mono">
                  Transfer from <span className="font-mono text-mm-textDark dark:text-white font-bold bg-gray-50 dark:bg-[#1f1f1a] px-1 rounded">{tx.sender_id}</span> to <span className="font-mono text-mm-textDark dark:text-white font-bold bg-gray-50 dark:bg-[#1f1f1a] px-1 rounded">{tx.receiver_id}</span> for <span className="font-mono font-bold text-[#ff4d4d]">${tx.amount}</span> flagged by heuristic engine.
                </div>
